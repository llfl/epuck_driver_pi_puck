...
void updateActuators() {
    ...
    if(changedActuators[MOTORS]) {
        ...
        zero_to_epuck_buff[0] = uint8_t(speedLeft&0x00FF);
        ...
        std::cout << "set left speed:" << int(zero_to_epuck_buff[0]) << "," << int(zero_to_epuck_buff[1]) << ", set right speed:" << int(zero_to_epuck_buff[2]) << "," << int(zero_to_epuck_buff[3]) << std::endl;
